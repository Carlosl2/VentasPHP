...
function init(){
    ...
    $('#mCliente').addClass("treeview active");
    $('#lRegistroCliente').addClass("active");
}
...
{
	bootbox.confirm("¿Está Seguro de desactivar este Cliente?", function(result){
		if(result)
        {
...
{
	bootbox.confirm("¿Está Seguro de activar este Cliente?", function(result){
		if(result)
        {
...
{
	bootbox.confirm("¿Está Seguro  eliminar este Cliente?", function(result){
		if(result)
        {
