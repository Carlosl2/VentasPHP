...
{
	bootbox.confirm("¿Está Seguro de desactivar este permiso?", function(result){
		if(result)
        {
...
{
	bootbox.confirm("¿Está Seguro de activar este permiso?", function(result){
		if(result)
        {
...
{
	bootbox.confirm("¿Está Seguro  eliminar este permiso?", function(result){
		if(result)
        {
