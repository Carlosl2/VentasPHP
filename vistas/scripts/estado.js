...
{
	bootbox.confirm("¿Está Seguro de desactivar Estado?", function(result){
		if(result)
        {
        	$.post("../ajax/estado.php?op=desactivar", {idestado : idestado}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
...
function activar(idestado)
{
	bootbox.confirm("¿Está Seguro de activar el  estado?", function(result){
		if(result)
        {
        	$.post("../ajax/estado.php?op=activar", {idestado : idestado}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
